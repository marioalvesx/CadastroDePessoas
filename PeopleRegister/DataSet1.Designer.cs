...
namespace PeopleRegister {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class pessoasDataTable : global::System.Data.TypedTableBase<pessoasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public pessoasRow AddpessoasRow(string Nome, string Telefone) {
...
namespace PeopleRegister.DataSet1TableAdapters {
    ...
    public partial class pessoasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[pessoas] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 A" +
                "ND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Telefone = 1 AND " +
                "[Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[pessoas] ([Nome], [Telefone]) VALUES (@Nome, @Telefone);\r\nSELE" +
                "CT Id, Nome, Telefone FROM pessoas WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[pessoas] SET [Nome] = @Nome, [Telefone] = @Telefone WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)));
SELECT Id, Nome, Telefone FROM pessoas WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PeopleRegister.Properties.Settings.Default.SqlConnection;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, Telefone FROM dbo.pessoas";
